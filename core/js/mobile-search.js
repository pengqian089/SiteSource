...
(function() {
    ...
    function createMobileSearchElements() {
        ...
        container.innerHTML = `
            ...
            <form class="mobile-search-form" action="/search" method="get">
                <input type="text" class="mobile-search-input" name="keywords" placeholder="搜索文章、标签、内容..." autocomplete="off">
    ...
    function bindMobileSearchEvents() {
        ...
        function performSearch(e) {
            ...
            // 执行搜索
            const searchUrl = form.action + '?keywords=' + encodeURIComponent(keywords);
