    ...
    $.fn.removeStyle = function(style){
        return this.each(function(){
            ...
            $.each(styles,function(){
                let search = new RegExp(this.toString() + '[^;]+;?', 'g');
    ...
    let methods = {
        init: function(settings){
            return this.each(function(){
                ...
                let prefix = $.support.leadingWhitespace ? prefix11($container[0]) : false;
                ...
                let $pagers = $pagerList.find('.page');
